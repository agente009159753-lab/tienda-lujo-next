...
export default function ArteCatalog() {
  ...
  useEffect(() => {
    ...
    setProducts(all.filter(p => p.category === 'arte'));
  }, []);
  ...
  return (
    <>
      ...
      <main className="container py-12 min-h-screen">
        <h1 className="text-4xl font-serif mb-2">Colección de Arte</h1>
        <p className="text-gray-500 mb-8">Pinturas, esculturas y fotografías de artistas selectos.</p>
