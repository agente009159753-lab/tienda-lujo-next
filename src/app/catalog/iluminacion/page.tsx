...
export default function IluminacionCatalog() {
  ...
  return (
    <>
      ...
      <main className="container py-12 min-h-screen">
        <h1 className="text-4xl font-serif mb-2">Diseño de Iluminación</h1>
        <p className="text-gray-500 mb-8">Lámparas de pie, candelabros y luz de ambiente de las mejores casas.</p>
